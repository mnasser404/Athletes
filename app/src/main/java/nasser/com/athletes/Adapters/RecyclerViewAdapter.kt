...
class RecyclerViewAdapter(var context: Context?, var atheletList: List<AthleteModel.Athele>) : RecyclerView.Adapter<RecyclerViewAdapter.AtheleHolder>() {
    ...
    override fun onCreateViewHolder(viewGroup: ViewGroup, p1: Int): RecyclerViewAdapter.AtheleHolder {
    ...
    override fun onBindViewHolder(holder: RecyclerViewAdapter.AtheleHolder, position: Int) {
